...
> **Autoritativni izvor istine:** [Official Rules](https://amazonappdev2026.devpost.com/rules) & NotebookLM (`82440dea-0a12-40a7-a249-0ba460f69611`)  
...
| **MCP 2025-11-25 Spec** | ✅ `test_protocol.py` | ✅ 8 protokolskih testova prolaze | Čeka unos | ✅ **VERIFIKOVANO TESTOM** |
| **Streamable HTTP Transport** | ✅ JSON-RPC POST + SSE | ✅ Razdvojen MCP POST od UI telemetry SSE | — | ✅ **VERIFIKOVANO** |
| **AWS Bedrock: Claude 3.5** | ✅ Implementiran payload | ✅ `bedrock_client.py` live & fallback | Čeka unos teksta | ✅ **VERIFIKOVANO** |
| **AWS Bedrock: Titan podrška** | ✅ `inputText`/`textGenerationConfig` | ✅ Implementirana Titan grana u kodu | Čeka unos teksta | ✅ **VERIFIKOVANO** |
| **Policy Grounding (NotebookLM)** | ✅ Transparentan lokalni korpus | ✅ Pošteno opisano bez lažnih live tvrdnji | — | ✅ **TRANSPARENTNO** |
| **Open Source Mini-Challenge** | ✅ Zaseban dodatni repo | ✅ [kiza-zmaj/judgeguard-policy-schema](https://github.com/kiza-zmaj/judgeguard-policy-schema) | Čeka unos URL-a | ✅ **DODATNI REPO SPREMAN** |
| **Automatizovani testovi** | ✅ 19/19 passed (0.093s) | ✅ `test_server.py` + `test_protocol.py` | — | ✅ **VERIFIKOVANO** |
...
2. **Open Source Mini-Challenge (Dodatni open-source repozitorijum):**  
   ...
   - *GitHub username:* `kizabgd123` / `kiza-zmaj`  
   - *Opis:* Samostalna Pydantic v2 biblioteka i rule engine za definisanje bezbednosnih polisa i MCP granica za AI agente.
...
# Pokretanje kompletne verifikacione baterije (19 testova)
